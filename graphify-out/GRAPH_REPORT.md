...
- [[_COMMUNITY_containers Cluster|containers Cluster]]
- [[_COMMUNITY_text_format Cluster|text_format Cluster]]
- [[_COMMUNITY_api Cluster|api Cluster]]
- [[_COMMUNITY_python_message Cluster|python_message Cluster]]
...
- [[_COMMUNITY_service_reflection Cluster|service_reflection Cluster]]
...
- [[_COMMUNITY_SettingsThemePreviewSpecimenTest Cluster|SettingsThemePreviewSpecimenTest Cluster]]
- [[_COMMUNITY_run_theme_perf_release_live Cluster|run_theme_perf_release_live Cluster]]
...
- [[_COMMUNITY_ReaderScreenThemeReactivityTest Cluster|ReaderScreenThemeReactivityTest Cluster]]
- [[_COMMUNITY_ImportRouting Cluster|ImportRouting Cluster]]
- [[_COMMUNITY_proto_builder Cluster|proto_builder Cluster]]
...
- [[_COMMUNITY_EpubParserBooksTest Cluster|EpubParserBooksTest Cluster]]
...
- [[_COMMUNITY_builder Cluster|builder Cluster]]
- [[_COMMUNITY_summarize_reader_lag_trace Cluster|summarize_reader_lag_trace Cluster]]
...
- [[_COMMUNITY_SettingsManagerProgressPersistenceTest Cluster|SettingsManagerProgressPersistenceTest Cluster]]
...
- [[_COMMUNITY_ThemeEditorModels Cluster|ThemeEditorModels Cluster]]
...
- [[_COMMUNITY_EpubParserEditingTest Cluster|EpubParserEditingTest Cluster]]
- [[_COMMUNITY_ImportRoutingTest Cluster|ImportRoutingTest Cluster]]
- [[_COMMUNITY_SettingsManagerThemePersistenceTest Cluster|SettingsManagerThemePersistenceTest Cluster]]
- [[_COMMUNITY_ReaderControlsSettingsUpdateTest Cluster|ReaderControlsSettingsUpdateTest Cluster]]
- [[_COMMUNITY_ReaderTextSelectionSessionTest Cluster|ReaderTextSelectionSessionTest Cluster]]
- [[_COMMUNITY_EpubParserPdfFallbackTest Cluster|EpubParserPdfFallbackTest Cluster]]
- [[_COMMUNITY_SettingsManagerJsonTest Cluster|SettingsManagerJsonTest Cluster]]
- [[_COMMUNITY_EditBookModelsTest Cluster|EditBookModelsTest Cluster]]
- [[_COMMUNITY_ReaderScreenRestorationTest Cluster|ReaderScreenRestorationTest Cluster]]
- [[_COMMUNITY_ReaderSystemBarTest Cluster|ReaderSystemBarTest Cluster]]
- [[_COMMUNITY_ReaderScreenContractsTest Cluster|ReaderScreenContractsTest Cluster]]
- [[_COMMUNITY_AppNavigationBindings Cluster|AppNavigationBindings Cluster]]
...
- [[_COMMUNITY_ThemeEditorGuidedColorEditTest Cluster|ThemeEditorGuidedColorEditTest Cluster]]
- [[_COMMUNITY_ThemeEditorModeInferenceTest Cluster|ThemeEditorModeInferenceTest Cluster]]
- [[_COMMUNITY_text_encoding Cluster|text_encoding Cluster]]
- [[_COMMUNITY_AppLog Cluster|AppLog Cluster]]
- [[_COMMUNITY_EpubParserChapterTest Cluster|EpubParserChapterTest Cluster]]
- [[_COMMUNITY_EpubParserImportTest Cluster|EpubParserImportTest Cluster]]
...
- [[_COMMUNITY_proto_builder Cluster|proto_builder Cluster]]
- [[_COMMUNITY_api_implementation Cluster|api_implementation Cluster]]
...
- [[_COMMUNITY_EpubParserScanCacheTest Cluster|EpubParserScanCacheTest Cluster]]
- [[_COMMUNITY_EditBookDetailsTab Cluster|EditBookDetailsTab Cluster]]
...
- [[_COMMUNITY_cpp_message Cluster|cpp_message Cluster]]
- [[_COMMUNITY_repo_utils Cluster|repo_utils Cluster]]
- [[_COMMUNITY_AppNavigationLibraryMutations Cluster|AppNavigationLibraryMutations Cluster]]
- [[_COMMUNITY_AppNavigationProgress Cluster|AppNavigationProgress Cluster]]
- [[_COMMUNITY_AppWarmUpScreen Cluster|AppWarmUpScreen Cluster]]
- [[_COMMUNITY_LibrarySelectionActionBar Cluster|LibrarySelectionActionBar Cluster]]
- [[_COMMUNITY_ReaderStatusSettingsRow Cluster|ReaderStatusSettingsRow Cluster]]
- [[_COMMUNITY_ReaderUiSupport Cluster|ReaderUiSupport Cluster]]
- [[_COMMUNITY_PdfReaderScreen Cluster|PdfReaderScreen Cluster]]
- [[_COMMUNITY_ReaderSelectableTextStructureTest Cluster|ReaderSelectableTextStructureTest Cluster]]
- [[_COMMUNITY_ReaderScreenBindings Cluster|ReaderScreenBindings Cluster]]
- [[_COMMUNITY_ReaderScreenEffects Cluster|ReaderScreenEffects Cluster]]
- [[_COMMUNITY_ReaderTopBarAndFab Cluster|ReaderTopBarAndFab Cluster]]
- [[_COMMUNITY_ReaderVerticalScrubber Cluster|ReaderVerticalScrubber Cluster]]
...
- [[_COMMUNITY_descriptor_pb2 Cluster|descriptor_pb2 Cluster]]
...
- [[_COMMUNITY_AppNavigationImport Cluster|AppNavigationImport Cluster]]
...
- [[_COMMUNITY_AppNavigationStartupEffect Cluster|AppNavigationStartupEffect Cluster]]
...
- [[_COMMUNITY_python_edition_defaults Cluster|python_edition_defaults Cluster]]
- [[_COMMUNITY_shell Cluster|shell Cluster]]
- [[_COMMUNITY_LibraryDataContracts Cluster|LibraryDataContracts Cluster]]
- [[_COMMUNITY_MainActivityCompat Cluster|MainActivityCompat Cluster]]
- [[_COMMUNITY_any_pb2 Cluster|any_pb2 Cluster]]
- [[_COMMUNITY_api_pb2 Cluster|api_pb2 Cluster]]
- [[_COMMUNITY_descriptor_rationale_484 Cluster|descriptor_rationale_484 Cluster]]
- [[_COMMUNITY_descriptor_rationale_796 Cluster|descriptor_rationale_796 Cluster]]
- [[_COMMUNITY_descriptor_rationale_804 Cluster|descriptor_rationale_804 Cluster]]
- [[_COMMUNITY_descriptor_rationale_809 Cluster|descriptor_rationale_809 Cluster]]
- [[_COMMUNITY_descriptor_rationale_820 Cluster|descriptor_rationale_820 Cluster]]
- [[_COMMUNITY_descriptor_rationale_841 Cluster|descriptor_rationale_841 Cluster]]
- [[_COMMUNITY_descriptor_rationale_860 Cluster|descriptor_rationale_860 Cluster]]
- [[_COMMUNITY_descriptor_rationale_968 Cluster|descriptor_rationale_968 Cluster]]
- [[_COMMUNITY_duration_pb2 Cluster|duration_pb2 Cluster]]
- [[_COMMUNITY_empty_pb2 Cluster|empty_pb2 Cluster]]
- [[_COMMUNITY_field_mask_pb2 Cluster|field_mask_pb2 Cluster]]
- [[_COMMUNITY_reflection Cluster|reflection Cluster]]
- [[_COMMUNITY_source_context_pb2 Cluster|source_context_pb2 Cluster]]
- [[_COMMUNITY_struct_pb2 Cluster|struct_pb2 Cluster]]
- [[_COMMUNITY_timestamp_pb2 Cluster|timestamp_pb2 Cluster]]
- [[_COMMUNITY_type_pb2 Cluster|type_pb2 Cluster]]
- [[_COMMUNITY_wrappers_pb2 Cluster|wrappers_pb2 Cluster]]
- [[_COMMUNITY___init__ Cluster|__init__ Cluster]]
- [[_COMMUNITY_plugin_pb2 Cluster|plugin_pb2 Cluster]]
- [[_COMMUNITY___init__ Cluster|__init__ Cluster]]
- [[_COMMUNITY___init__ Cluster|__init__ Cluster]]
- [[_COMMUNITY___init__ Cluster|__init__ Cluster]]
- [[_COMMUNITY___init__ Cluster|__init__ Cluster]]
- [[_COMMUNITY___init__ Cluster|__init__ Cluster]]
- [[_COMMUNITY_trace_data_checks Cluster|trace_data_checks Cluster]]
- [[_COMMUNITY___init__ Cluster|__init__ Cluster]]
- [[_COMMUNITY___init__ Cluster|__init__ Cluster]]
- [[_COMMUNITY_perfetto_trace_pb2 Cluster|perfetto_trace_pb2 Cluster]]
- [[_COMMUNITY___init__ Cluster|__init__ Cluster]]
- [[_COMMUNITY_resolver_rationale_120 Cluster|resolver_rationale_120 Cluster]]
- [[_COMMUNITY___init__ Cluster|__init__ Cluster]]
- [[_COMMUNITY_update_protocol Cluster|update_protocol Cluster]]

## God Nodes (most connected - your core abstractions)
1. `FieldDescriptor` - 86 edges
2. `DescriptorPool` - 48 edges
3. `Message` - 44 edges
4. `PlatformDelegate` - 40 edges
5. `TraceProcessor` - 36 edges
6. `ResolverRegistry` - 35 edges
7. `Tokenizer` - 33 edges
8. `SettingsManager` - 32 edges
9. `PerfettoException` - 31 edges
10. `SettingsThemePreviewSpecimenTest` - 29 edges

## Surprising Connections (you probably didn't know these)
- `Base container class.` --uses--> `FieldDescriptor`  [INFERRED]
  C:\Users\Amon\Desktop\projects\bluewaves_v1\logs\_perfetto_py\google\protobuf\internal\containers.py → C:\Users\Amon\Desktop\projects\bluewaves_v1\logs\_perfetto_py\google\protobuf\descriptor.py
- `Args:       message_listener: A MessageListener implementation.         The Repe` --uses--> `FieldDescriptor`  [INFERRED]
  C:\Users\Amon\Desktop\projects\bluewaves_v1\logs\_perfetto_py\google\protobuf\internal\containers.py → C:\Users\Amon\Desktop\projects\bluewaves_v1\logs\_perfetto_py\google\protobuf\descriptor.py
- `Retrieves item by the specified key.` --uses--> `FieldDescriptor`  [INFERRED]
  C:\Users\Amon\Desktop\projects\bluewaves_v1\logs\_perfetto_py\google\protobuf\internal\containers.py → C:\Users\Amon\Desktop\projects\bluewaves_v1\logs\_perfetto_py\google\protobuf\descriptor.py
- `Returns the number of elements in the container.` --uses--> `FieldDescriptor`  [INFERRED]
  C:\Users\Amon\Desktop\projects\bluewaves_v1\logs\_perfetto_py\google\protobuf\internal\containers.py → C:\Users\Amon\Desktop\projects\bluewaves_v1\logs\_perfetto_py\google\protobuf\descriptor.py
- `Checks if another instance isn't equal to this one.` --uses--> `FieldDescriptor`  [INFERRED]
  C:\Users\Amon\Desktop\projects\bluewaves_v1\logs\_perfetto_py\google\protobuf\internal\containers.py → C:\Users\Amon\Desktop\projects\bluewaves_v1\logs\_perfetto_py\google\protobuf\descriptor.py

## Communities

### Community 0 - "containers Cluster"
Cohesion: 0.02
Nodes (93): BaseContainer, data(), field_number(), MessageMap, Simple, type-checked, list-like container for holding repeated scalars., Args:        message_listener: A MessageListener implementation. The       Repea, Appends an item to the list. Similar to list.append()., Inserts the item at the specified position. Similar to list.insert(). (+85 more)
...
Cohesion: 0.04
Nodes (45): BatchTraceProcessor, BatchTraceProcessorConfig, FailureHandling, Observer, Observer that can be used to provide side-channel information about     processe, Invoked every time query has been executed on a trace.        Args:         meta, Create a trace processor instance.      Args:       trace: reference to a trace, Creates a batch trace processor instance.      BatchTraceProcessor is the blesse (+37 more)

### Community 3 - "python_message Cluster"
Cohesion: 0.03
Nodes (103): DescriptorMetaclass, property, _AddByteSizeMethod(), _AddClassAttributesForNestedExtensions(), _AddClearExtensionMethod(), _AddClearFieldMethod(), _AddContainsMethod(), _AddEnumValues() (+95 more)

### Community 4 - "well_known_types Cluster"
Cohesion: 0.03
Nodes (51): Any, _CheckDurationValid(), _CheckTimestampValid(), Duration, _GetStructValue(), ListValue, Parse a RFC 3339 date string format to Timestamp.      Args:       value: A date, Get the current UTC into Timestamp. (+43 more)

### Community 5 - "descriptor Cluster"
Cohesion: 0.03
Nodes (71): camelcase_name(), _Deprecated(), Descriptor, DescriptorBase, EnumDescriptor, EnumValueDescriptor, Error, FileDescriptor (+63 more)
...
Cohesion: 0.1
Nodes (13): Default(), Registers the given file descriptor in the local database.      Args:       file, Tries to find a symbol in the local database.      Currently, this method only r, # TODO: Fix the differences with MessageFactory., Gets all registered messages from a specified file.      Only messages already c, Returns the default SymbolDatabase., A database of Python generated symbols., Initializes a new SymbolDatabase. (+5 more)

### Community 27 - "AppNavigationLibraryDataTest Cluster"
Cohesion: 0.1
Nodes (1): AppNavigationLibraryDataTest

### Community 28 - "SettingsScreenPersistenceTestSupport Cluster"
Cohesion: 0.1
Nodes (0): 

### Community 29 - "SettingsThemeEditorModeInferenceTest Cluster"
Cohesion: 0.1
...
### Community 201 - "__init__ Cluster"
Cohesion: 1.0
Nodes (0): 
...
### Community 203 - "__init__ Cluster"
Cohesion: 1.0
Nodes (0): 
...
- **Thin community `AppNavigationEffects Cluster`** (2 nodes): `AppNavigationSideEffects()`, `AppNavigationEffects.kt`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `AppNavigationImport Cluster`** (2 nodes): `rememberBookImportLauncher()`, `AppNavigationImport.kt`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `AppNavigationLibrary Cluster`** (2 nodes): `LibraryScreen()`, `AppNavigationLibrary.kt`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `AppNavigationScreenHost Cluster`** (2 nodes): `AppNavigationScreenHost()`, `AppNavigationScreenHost.kt`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `AppNavigationStartupEffect Cluster`** (2 nodes): `AppNavigationStartupEffect()`, `AppNavigationStartupEffect.kt`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `LibraryBookGrid Cluster`** (2 nodes): `LibraryBookGrid.kt`, `LibraryBookGrid()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `LibraryDrawerContent Cluster`** (2 nodes): `LibraryDrawerContent.kt`, `LibraryDrawerContent()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `ReaderScreen Cluster`** (2 nodes): `ReaderScreen.kt`, `ReaderScreen()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `ReaderScreenControls Cluster`** (2 nodes): `ReaderScreenControls.kt`, `ReaderControls()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `ReaderTocDrawer Cluster`** (2 nodes): `ReaderTocDrawer.kt`, `ReaderTocDrawerContent()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `SettingsAppearanceGalleryHost Cluster`** (2 nodes): `SettingsAppearanceGalleryHost.kt`, `AppearanceGalleryHost()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `ThemeEditorPreviewCard Cluster`** (2 nodes): `ThemeEditorPreviewCard.kt`, `ThemeEditorPreviewCard()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `python_edition_defaults Cluster`** (2 nodes): `python_edition_defaults.py`, `This file contains the serialized FeatureSetDefaults object corresponding to the`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `shell Cluster`** (2 nodes): `shell.py`, `load_shell()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `LibraryDataContracts Cluster`** (1 nodes): `LibraryDataContracts.kt`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `MainActivityCompat Cluster`** (1 nodes): `MainActivityCompat.kt`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `any_pb2 Cluster`** (1 nodes): `any_pb2.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `api_pb2 Cluster`** (1 nodes): `api_pb2.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `descriptor_rationale_484 Cluster`** (1 nodes): `Same FieldDescriptor objects as in :attr:`fields`, but indexed by      :attr:`Fi`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `descriptor_rationale_796 Cluster`** (1 nodes): `Returns if the field is required.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `descriptor_rationale_804 Cluster`** (1 nodes): `Returns if the field is repeated.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `descriptor_rationale_809 Cluster`** (1 nodes): `Camelcase name of this field.      Returns:       str: the name in CamelCase.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `descriptor_rationale_820 Cluster`** (1 nodes): `Whether the field distinguishes between unpopulated and default values.      Rai`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `descriptor_rationale_841 Cluster`** (1 nodes): `Returns if the field is packed.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `descriptor_rationale_860 Cluster`** (1 nodes): `Converts from a Python proto type to a C++ Proto Type.      The Python ProtocolB`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `descriptor_rationale_968 Cluster`** (1 nodes): `Returns true whether this is a "closed" enum.      This means that it:     - Has`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `duration_pb2 Cluster`** (1 nodes): `duration_pb2.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `empty_pb2 Cluster`** (1 nodes): `empty_pb2.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `field_mask_pb2 Cluster`** (1 nodes): `field_mask_pb2.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `reflection Cluster`** (1 nodes): `reflection.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `source_context_pb2 Cluster`** (1 nodes): `source_context_pb2.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `struct_pb2 Cluster`** (1 nodes): `struct_pb2.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `timestamp_pb2 Cluster`** (1 nodes): `timestamp_pb2.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `type_pb2 Cluster`** (1 nodes): `type_pb2.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `wrappers_pb2 Cluster`** (1 nodes): `wrappers_pb2.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `__init__ Cluster`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `plugin_pb2 Cluster`** (1 nodes): `plugin_pb2.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `__init__ Cluster`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `__init__ Cluster`** (1 nodes): `__init__.py`
...
- **Thin community `__init__ Cluster`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `trace_data_checks Cluster`** (1 nodes): `trace_data_checks.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `__init__ Cluster`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `__init__ Cluster`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `perfetto_trace_pb2 Cluster`** (1 nodes): `perfetto_trace_pb2.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `__init__ Cluster`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `resolver_rationale_120 Cluster`** (1 nodes): `Creates a resolver from a URI.      URIs have the form:     android_ci:day=2021-`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `__init__ Cluster`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Are the 5 inferred relationships involving `DescriptorPool` (e.g. with `Converts protobuf message to a dictionary.    When the dictionary is encoded to` and `Parses a JSON dictionary representation into a message.    Args:     message_cla`) actually correct?**
  _`DescriptorPool` has 5 INFERRED edges - model-reasoned connections that need verification._
- **Are the 11 inferred relationships involving `Message` (e.g. with `Return the serialized proto.    Args:     message: The proto message to be seria` and `Given a serialized data in binary form, deserialize it into a Message.    Args:`) actually correct?**
  _`Message` has 11 INFERRED edges - model-reasoned connections that need verification._
- **Are the 29 inferred relationships involving `PlatformDelegate` (e.g. with `FailureHandling` and `BatchTraceProcessorConfig`) actually correct?**
  _`PlatformDelegate` has 29 INFERRED edges - model-reasoned connections that need verification._