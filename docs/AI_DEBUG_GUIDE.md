...
- Then inspect `app/AppRoute.kt`, `app/AppSurfaceRegistry.kt`, `app/AppNavigation.kt`, and the owning `*SurfacePlugin.kt`.
...
- Start with `feature/editbook/EditBookSurfacePlugin.kt` and `docs/epub_parsing.md`.
...
- Start with `docs/app_shell_navigation.md`.
- Then inspect `app/AppNavigation.kt`, `app/AppSurfaceRegistry.kt`, and `feature/pdf-legacy/PdfLegacyLegoPlugin.kt`.
