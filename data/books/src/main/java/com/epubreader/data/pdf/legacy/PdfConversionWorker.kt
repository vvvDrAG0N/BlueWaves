...
import com.epubreader.data.books.R
import kotlinx.coroutines.CancellationException

fun enqueuePdfConversionWork(
    context: Context,
    bookId: String,
) {
...
fun uniquePdfConversionWorkName(bookId: String): String = "pdf-conversion-$bookId"
...
internal class PdfConversionWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        return try {
            ...
            val parser = EpubParser.create(applicationContext)
...
const val PDF_CONVERSION_WORK_TAG = "pdf-conversion"
const val PDF_CONVERSION_BOOK_ID_KEY = "pdf_conversion_book_id"
const val PDF_CONVERSION_COMPLETED_KEY = "pdf_conversion_completed"
const val PDF_CONVERSION_TOTAL_KEY = "pdf_conversion_total"
const val PDF_CONVERSION_STATUS_KEY = "pdf_conversion_status"
