...
internal data class GlobalSettingsSnapshot(
    val fontSize: Int,
    val fontType: String,
    val theme: String,
    ...
    val showScrubber: Boolean,
    val showSystemBar: Boolean,
    val selectableText: Boolean,
    val hapticFeedback: Boolean,
    val allowBlankCovers: Boolean,
    val librarySort: String,
    val favoriteLibrary: String,
    ...
    val readerStatusShowChapterProgress: Boolean,
    val readerStatusShowChapterNumber: Boolean,
)
...
internal fun Preferences.toGlobalSettings(): GlobalSettings {
    return toGlobalSettingsSnapshot().toGlobalSettings()
}

internal fun Preferences.toGlobalSettingsSnapshot(): GlobalSettingsSnapshot {
    return GlobalSettingsSnapshot(
        ...
        theme = this[SettingsPreferenceKeys.theme] ?: LightThemeId,
        customThemes = this[SettingsPreferenceKeys.customThemes] ?: EmptyJsonArray,
        ...
        readerStatusShowChapterProgress = this[SettingsPreferenceKeys.readerStatusShowChapterProgress] ?: false,
        readerStatusShowChapterNumber = this[SettingsPreferenceKeys.readerStatusShowChapterNumber] ?: true,
    )
}

internal fun GlobalSettingsSnapshot.toGlobalSettings(): GlobalSettings {
    val customThemes = parseCustomThemes(customThemes)
    return GlobalSettings(
        fontSize = fontSize,
        fontType = fontType,
        theme = normalizeThemeSelection(theme, customThemes),
        ...
        allowBlankCovers = allowBlankCovers,
        ...
        readerStatusUi = com.epubreader.core.model.ReaderStatusUiState(
            ...
            showBattery = readerStatusShowBattery,
            showChapterProgress = readerStatusShowChapterProgress,
            showChapterNumber = readerStatusShowChapterNumber,
        ),
    )
}
