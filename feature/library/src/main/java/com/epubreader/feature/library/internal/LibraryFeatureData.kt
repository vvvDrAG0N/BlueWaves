 ...
 * PURPOSE: Pure helpers for derived library data inside the library feature.
...
internal data class LibraryDerivedData(
...
internal fun parseStringMap(value: String): Map<String, String> {
    return try {
        buildMap {
...
internal fun buildLibraryDerivedData(
    books: List<EpubBook>,
...
internal fun resolveCurrentSort(
...
internal fun buildVisibleProgressTargets(
