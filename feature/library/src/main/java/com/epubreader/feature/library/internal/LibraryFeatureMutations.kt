...
internal data class LibraryFeatureMutations(
...
internal fun buildLibraryFeatureMutations(
...
): LibraryFeatureMutations {
    return LibraryFeatureMutations(
        ...
        dragFolderBy = { dragAmountY, itemHeightPx ->
